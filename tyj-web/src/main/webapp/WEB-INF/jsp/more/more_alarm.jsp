    ...
    <body>
        <div id="newSearch">
            <form id="queryForm">
                ...
                <b>所属团队：</b>
                <input class="easyui-combobox" id="team" name="team" data-options="required:true" style="width:90px;"/>
                <b>开始时间：</b>
...
<script type="text/javascript" src="<c:url value="/"/>js/page/more/more_action.js"></script>